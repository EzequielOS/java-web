...
<body>
	...
	<div class="container">
		...
		<form method="get" name="myform" class="form-horizontal"
			...
			<div class="form-group">
				<label class="col-sm-2 control-label" for="anoMin">Ano
					Minimo:</label>
				<div class="col-sm-5">
					<input type="number" name="anoMin" id="anoMin" value=" "
						required="required" class="form-control" />
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label" for="anoMax">Ano
					máximo:</label>
				<div class="col-sm-5">
					<input type="number" name="anoMax" id="anoMax" value=""
						required="required" class="form-control" />
				</div>
			</div>
